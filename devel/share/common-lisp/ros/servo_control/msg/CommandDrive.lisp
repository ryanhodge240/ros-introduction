...
(cl:defmethod cl:initialize-instance :after ((m <CommandDrive>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CommandDrive)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name servo_control-msg:<CommandDrive> is deprecated: use servo_control-msg:CommandDrive instead.")))

(cl:ensure-generic-function 'left_front_vel-val :lambda-list '(m))
(cl:defmethod left_front_vel-val ((m <CommandDrive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servo_control-msg:left_front_vel-val is deprecated.  Use servo_control-msg:left_front_vel instead.")
  (left_front_vel m))

(cl:ensure-generic-function 'left_middle_vel-val :lambda-list '(m))
(cl:defmethod left_middle_vel-val ((m <CommandDrive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servo_control-msg:left_middle_vel-val is deprecated.  Use servo_control-msg:left_middle_vel instead.")
  (left_middle_vel m))

(cl:ensure-generic-function 'left_back_vel-val :lambda-list '(m))
(cl:defmethod left_back_vel-val ((m <CommandDrive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servo_control-msg:left_back_vel-val is deprecated.  Use servo_control-msg:left_back_vel instead.")
  (left_back_vel m))

(cl:ensure-generic-function 'right_front_vel-val :lambda-list '(m))
(cl:defmethod right_front_vel-val ((m <CommandDrive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servo_control-msg:right_front_vel-val is deprecated.  Use servo_control-msg:right_front_vel instead.")
  (right_front_vel m))

(cl:ensure-generic-function 'right_middle_vel-val :lambda-list '(m))
(cl:defmethod right_middle_vel-val ((m <CommandDrive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servo_control-msg:right_middle_vel-val is deprecated.  Use servo_control-msg:right_middle_vel instead.")
  (right_middle_vel m))

(cl:ensure-generic-function 'right_back_vel-val :lambda-list '(m))
(cl:defmethod right_back_vel-val ((m <CommandDrive>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader servo_control-msg:right_back_vel-val is deprecated.  Use servo_control-msg:right_back_vel instead.")
  (right_back_vel m))
